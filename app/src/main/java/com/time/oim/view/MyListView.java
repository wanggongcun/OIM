...
//        setCacheColorHint(context.getResources().getColor(R.color.transparent));  
        ...
        headerView = (LinearLayout) inflater.inflate(R.layout.refresh_list_header, null);  
        lvHeaderTipsTv = (TextView) headerView.findViewById(R.id.refresh_list_header_text);  
        lvHeaderLastUpdatedTv = (TextView) headerView.findViewById(R.id.refresh_list_header_last_update);  
...
//        lvHeaderArrowIv.setMinimumHeight(50);  
        ...
        lvHeaderProgressBar = (ProgressBar) headerView.findViewById(R.id.refresh_list_header_progressbar);  
...
//            lvHeaderArrowIv.setImageResource(R.drawable.arrow);  
    ...
    public void setAdapter(ShuoshuoAdapter adapter) {  
        lvHeaderLastUpdatedTv.setText("最近更新:" + new Date().toLocaleString());  
