...
public class Constant {
	...
	public static final String OIM_VERSION = "oim_version";
	public static final String OIM_VERSION_LAST = "oim_version_last";
	public static final String OIM_UPDATE_URL = "oim_update_url";
	public static final String OIM_ACTION = "oim_action";
	/**
	 * 登录提示
	 */
